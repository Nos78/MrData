 ...
 * @Last Modified time: 2020-10-08 22:22:40
 */
...
module.exports = {
    ...
    aliases: ['ptd', 'playertotaldestroyed'],
    args: false,
    usage: '<number>',
    version: '1.0.4',
    category: 'scoring',
        ...
        switch (args.length) {
            case 0:
                ...
                db.scores.findByUserAndGuild(message.author.id, message.guild.id)
                    .then(author_score => {
                        db.scores.findByGuild(message.guild.id, `pvp_total_damage DESC LIMIT ${maxRankCount}`)
                            .then(top10 => {
                                ...
                                if (top10 == null || top10.length == 0) {
                                    ...
                                    const embed = new Discord.MessageEmbed()
                                        ...
                                        .setDescription(`Our top ${maxRankCount} PvP Total Damage scores!`)
