 ...
 * @Last modified time: 2019-05-08T16:43:21+01:00
 */
...
module.exports = {
    ...
    description: 'See the top 10 hostiles total damage scores, or set your own hostiles total damage score.',
    aliases: ['htd'],
    args: false,
    usage: '<number>',
    cooldown: 3,
        ...
        switch (args.length) {
            case 0:
                ...
                db.scores.findByUserAndGuild(message.author.id, message.guild.id)
                    .then(author_score => {
                        db.scores.findByGuild(message.guild.id, 'hostiles_total_damage DESC LIMIT 10')
                            .then(top10 => {
                                ...
                                if (top10 == null || top10.length == 0) {
                                    ...
                                    const embed = new Discord.RichEmbed()
                                        ...
                                        .setDescription("Our top 10 Hostiles Total Damage scores!")
