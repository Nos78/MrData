 ...
 * @Last Modified time: 2020-09-29 03:36:59
 */
        ...
        switch (args.length) {
            case 0:
                ...
                db.scores.findByUserAndGuild(message.author.id, message.guild.id)
                    .then(author_score => {
                        db.scores.findByGuild(message.guild.id, `power_destroyed DESC LIMIT ${maxRankCount}`)
                            .then(top10 => {
                                ...
                                if (top10 == null || top10.length == 0) {
                                    ...
                                    const embed = new Discord.RichEmbed()
                                        ...
                                        .setDescription(`Our top ${maxRankCount} power destroyed scores!`)
