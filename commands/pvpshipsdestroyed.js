 ...
 * @Last modified time: 2020-03-29T19:09:28+01:00
 */
        ...
        switch (args.length) {
            case 0:
                ...
                db.scores.findByUserAndGuild(message.author.id, message.guild.id)
                    .then(author_score => {
                        db.scores.findByGuild(message.guild.id, `pvp_ships_destroyed DESC LIMIT ${maxRankCount}`)
                            .then(top10 => {
                                ...
                                if (top10 == null || top10.length == 0) {
                                    ...
                                    const embed = new Discord.RichEmbed()
                                        ...
                                        .setDescription(`Our top ${maxRankCount} PvP Ships Destroyed scores!`)
